  ...
  useEffect(() => {
    ...
    const fsSource = `
      ...
      void main() {
        ...
        // Pragna Gold base (#d4af37)
        color = vec3(0.831, 0.686, 0.216);
        // Mix with Pragna Deep Gold / Warm Amber (#b8860b)
        color = mix(color, vec3(0.722, 0.525, 0.043), 0.45 + 0.25 * sin(2.0 * u_scroll_progress + 1.2));
        // Add Pragna Soft Gold / Champagne (#e5c76b) highlight accent
